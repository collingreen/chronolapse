...
# -*- coding: ISO-8859-15 -*-
#
# generated by wxGlade 0.6.8 (standalone edition) on Mon Apr 14 02:29:58 2014
#
...
class chronoFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.instructionsmenuitem = wx.MenuItem(self.aboutmenu, wx.ID_ANY, _("Instructions"), "", wx.ITEM_NORMAL)
        ...
        self.donatemenu = wx.Menu()
        self.donatemenuitem = wx.MenuItem(self.donatemenu, wx.ID_ANY, _("Donate to Creator"), _("Donate to the creator of Chronolapse"), wx.ITEM_NORMAL)
        self.donatemenu.AppendItem(self.donatemenuitem)
        self.chronoframe_menubar.Append(self.donatemenu, _("Donate"))
        ...
        self.Bind(wx.EVT_MENU, self.donateMenuItemClicked, self.donatemenuitem)
    ...
    def donateMenuItemClicked(self, event):  # wxGlade: chronoFrame.<event_handler>
        print "Event handler 'donateMenuItemClicked' not implemented!"
        event.Skip()
...
class screenshotConfigDialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.screenshotconfigcancel.SetToolTipString(_("Return to main program without saving"))
        # end wxGlade
...
class webcamConfigDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.label_8 = wx.StaticText(self, wx.ID_ANY, _("Resolution:"))
        self.webcamresolutioncombo = wx.ComboBox(self, wx.ID_ANY, choices=[_("640, 480"), _("800, 600"), _("1024, 768"), _("1280, 1024")], style=wx.CB_DROPDOWN)
